...
const { ControllerDriver } = require("./controller/d2/controller_driver");
const { ModeDispatcher } = require("./controller/d2/mode_dispatcher");
const { BookmarkMode } = require("./controller/d2/modes/bookmark_mode");
...
function makeDefaultConfigController() {
  const configstore = new Configstore("taskolio-d2");
